...
public class OzelAdaptor extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View satir= mLayoutInflater.inflate(R.layout.satir,null);
...
final Veritabani vt = new Veritabani(satir.getContext());

        final Gorev gorev = gorevler.get(position);
        ...
        durum.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked) {
                    vt.gorevGuncelle(gorev.getId());
                }
            }
        });
